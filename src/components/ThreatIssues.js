      ...
      <div className="row g-4 mb-4">
        <div className="col-md-3">
          <div
            ...
            style={{ background: "#fff", border: "1px solid #dc3545" }}
          >
        ...
        <div className="col-md-3">
          <div
            className="card text-center"
            style={{ background: "#fff", border: "1px solid #fd7e14" }}
          >
            <div className="card-body">
        ...
        <div className="col-md-3">
          <div
            className="card text-center"
            style={{ background: "#fff", border: "1px solid #198754" }}
          >
            <div className="card-body">
        ...
        <div className="col-md-3">
          <div
            className="card text-center"
            style={{ background: "#fff", border: "1px solid #0d6efd" }}
          >
            <div className="card-body">
          ...
          >
            <thead className="table-light">
              <tr>
                ...
                <th style={{ color: "#0d6efd" }} className="text-center">
                  Actions
                </th>
              </tr>
            </thead>
